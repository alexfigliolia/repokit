...
use crate::executables::internal_executable_definition::RepoKitScope;
...
impl Logger {
    pub fn initialize(scope: &RepoKitScope) {
        ...
        Logger::with_registry(|mut registry| registry.set_theme(&scope.cache.theme_preference));
    }
